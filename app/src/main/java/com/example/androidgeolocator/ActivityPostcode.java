...
public class ActivityPostcode extends AppCompatActivity {
    ...
    private void establishmentInfoList(){
        ...
        String postcode = intent.getStringExtra("EditTextPostCode");
        String value = postcode;
        String JSON_URL = "http://sandbox.kriswelsh.com/hygieneapi/hygiene.php?op=search_postcode&postcode=" + value;
