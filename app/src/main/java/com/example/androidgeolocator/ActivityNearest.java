...
public class ActivityNearest extends AppCompatActivity {
...
//        TextView textview = findViewById(R.id.Latitude);
  //      TextView textview2 = findViewById(R.id.Latitude);
    ...
    //try as double or string for params, could work, if not add location data to this class perhaps????
